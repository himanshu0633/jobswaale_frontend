          ...
          <ResponsiveCardList
            ...
            renderCard={(item, index) => (
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-bold text-slate-800">{item.cityName}</div>
                    <div className="text-xs text-slate-500">ID: {String(item.ctid).padStart(3, '0')}</div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-xs text-slate-500">{item.district?.districtName || 'N/A'} • Sort: {item.sortingNo}</div>
