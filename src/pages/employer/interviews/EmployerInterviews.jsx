  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
        <h1 className="text-xl font-extrabold text-[#3f4254]">Interviews</h1>
        <div className="flex items-center gap-2 text-sm font-bold text-slate-400"><span className="text-[#3f4254]">JobsWaale</span><ChevronRight className="h-4 w-4" /><span>Interviews</span></div>
      </div>
      ...
      <section className="rounded-md border border-slate-100 bg-white shadow-sm">
        <div className="flex flex-col justify-between gap-4 border-b border-dashed border-slate-200 px-5 py-4 lg:flex-row lg:items-center">
          <div><h2 className="text-lg font-extrabold text-[#3f4254]">Interview Schedule</h2><p className="mt-1 text-sm font-semibold text-slate-400">Manage all upcoming, ongoing, and past interviews. Schedule, reschedule, or cancel as needed.</p></div>
