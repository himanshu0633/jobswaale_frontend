...
export const JobseekerPlaceholder = ({ title = 'Jobseeker Page' }) => (
  <div className="rounded-lg border border-slate-200 bg-white p-8 text-center shadow-sm">
    ...
    <p className="mx-auto mt-2 max-w-md text-sm font-semibold text-slate-500">
      This jobseeker section is ready in the new layout. Detailed features can be connected here next.
    </p>
...
export default JobseekerPlaceholder;