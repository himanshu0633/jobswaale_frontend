  ...
  return (
    <div className="w-full bg-white overflow-x-hidden ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:gap-12 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6 lg:py-[20px] lg:pr-[60px] text-center lg:text-left">
              ...
              {/* Simple centered banner image for mobile/tablet, replaces the floating desktop composition */}
              <div className="lg:hidden pt-2 pb-1">
                <img
                  src={bannerImg}
                  alt="jobhub"
                  className="max-w-[240px] sm:max-w-[300px] mx-auto"
                />
              </div>
            ...
            {/* Right Column - Banner Images (desktop only, floating composition) */}
      ...
      <section className="pt-12 sm:pt-16 lg:pt-[90px] pb-14 sm:pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-[#c2d9ff] rounded-[30px] sm:rounded-[50px] lg:rounded-[80px] pt-10 pb-10 px-6 sm:pt-16 sm:pb-16 sm:pl-5 sm:pr-12 overflow-hidden">
            <div className="relative z-10 grid gap-6 lg:gap-10 lg:grid-cols-2 items-center">
              ...
              <div className="text-center lg:text-left pt-2 px-0 lg:pt-[70px] lg:pl-[30px] lg:pr-[30px] pb-2 lg:pb-8">
                <span className="text-[#0047C7] text-lg sm:text-xl font-semibold">Find jobs</span>
      ...
      <section className="pt-12 sm:pt-16 lg:pt-[90px] pb-14 sm:pb-20 bg-white border-b border-[#ececec]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:gap-12 lg:grid-cols-2 items-center">
            {/* Left Content */}
            <div className="text-center lg:text-left">
              <span className="text-[#0047C7] text-lg sm:text-xl font-semibold">Online Marketing</span>
              ...
              <p className="text-[#37404e] text-base leading-relaxed mb-6 sm:mb-7">
                Proin ullamcorper pretium orci. Donec necscele risque leo. Nam massa dolor imperdiet neccon sequata congue idsem. Maecenas malesuada faucibus finibus.
              </p>
              <div>
                <Link
            ...
            {/* Simple centered image for mobile/tablet */}
            <div className="lg:hidden flex justify-center">
              <img
                src={onlineMarketing}
                alt="online marketing"
                className="max-w-[260px] sm:max-w-[340px] w-full"
              />
            </div>
          </div>
        </div>
