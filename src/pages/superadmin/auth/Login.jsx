        ...
        <div className="relative bg-white border border-slate-200 rounded-2xl shadow-xl p-6 sm:p-8 overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 max-w-xs mx-auto">
              Let’s get you signed in. <br /> Enter your email and password to continue.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Success Alert */}
            {success && (
              <div className="flex items-center gap-2.5 p-3 text-sm font-semibold border rounded-xl bg-emerald-50 border-emerald-100 text-emerald-800 animate-in fade-in slide-in-from-top-1 duration-200">
            ...
            {/* Error Alert */}
            {error && (
              <div className="flex items-center gap-2.5 p-3 text-sm font-semibold border rounded-xl bg-rose-50 border-rose-100 text-rose-800 animate-in fade-in slide-in-from-top-1 duration-200">
            ...
            {/* Password Input */}
            <div>
              <label htmlFor="userPassword" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
