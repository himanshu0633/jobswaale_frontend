...
export const PostJob = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm -ml-3 lg:-ml-5">
        ...
        <div className="p-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-5 lg:grid-cols-[minmax(0,2fr)_minmax(300px,1fr)] items-start">
              ...
              <div className="lg:sticky lg:top-20 lg:h-[calc(100vh-6.5rem)] flex flex-col justify-between rounded-xl bg-slate-50/70 p-4 border border-slate-200 shadow-sm">
                ...
                {/* Save Job Button at the bottom of the right part */}
                <div className="pt-3 border-t border-slate-200 mt-3 shrink-0">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold rounded-lg transition-colors disabled:opacity-60 shadow-sm"
                  >
